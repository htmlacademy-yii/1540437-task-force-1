...
class Nav extends Widget
{
    ...
    /**
     * @var array Параметры для каждого итема
     */
    public $itemOptions = [];
    ...
    public function init()
    {
        ...
        Html::addCssClass($this->options, ['widget' => 'header-nav__list']);
    }
    ...
    public function renderItem($item)
    {
        ...
        $options = ArrayHelper::getValue($item, 'options', ['class' => 'site-list__item ']);
        ...
        if ($active) {
            Html::addCssClass($options, 'site-list__item--active');
        }
